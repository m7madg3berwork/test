...
Route::group(['prefix' => 'v2/auth', 'middleware' => ['app_language']], function () {
    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        Route::get('logoutToken', function (Request $request) {
            $user = User::find(12);
            $user->tokens()->delete();
...
Route::group(['prefix' => 'v2', 'middleware' => ['app_language']], function () {
    ...
    Route::get('week-days', 'App\Http\Controllers\Api\V2\DailyTimeDailvaryController@getWeekDays');
    //IIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIII
    ...
    Route::get('user/package/item/remove/{id}', 'App\Http\Controllers\Api\V2\PackageController@removePackageItem')->middleware('auth:sanctum');
    //IIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIII
    Route::get('get-counts', 'App\Http\Controllers\Api\V2\CustomerController@getCounts')->middleware('auth:sanctum');
    //IIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIII
    Route::post('commercial-photos', 'App\Http\Controllers\Api\V2\SellerController@commercialPhoto')->middleware('auth:sanctum');
    Route::get('get-commercial-photos', 'App\Http\Controllers\Api\V2\SellerController@getCommercialPhotos')->middleware('auth:sanctum');
    //IIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIII
    Route::post('comp_prods-add-product', 'App\Http\Controllers\Api\V2\ComparisonProductsController@add')->middleware('auth:sanctum');
    Route::get('comp_prods-remove-product', 'App\Http\Controllers\Api\V2\ComparisonProductsController@remove')->middleware('auth:sanctum');
    Route::get('comp_prods', 'App\Http\Controllers\Api\V2\ComparisonProductsController@index')->middleware('auth:sanctum');
    Route::get('check_product_in_comparison_list', 'App\Http\Controllers\Api\V2\ComparisonProductsController@checkProductInComparisonList')->middleware('auth:sanctum');
    //IIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIII
    Route::post('add-units', 'App\Http\Controllers\Api\V2\UnitsController@add')->middleware('auth:sanctum');
    Route::get('remove-units', 'App\Http\Controllers\Api\V2\UnitsController@remove')->middleware('auth:sanctum');
    Route::get('get-units', 'App\Http\Controllers\Api\V2\UnitsController@index')->middleware('auth:sanctum');
    Route::get('all-units', 'App\Http\Controllers\Api\V2\UnitsController@index');
    //IIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIII
    Route::get('hyperpay-get-checkoutId', 'App\Http\Controllers\Api\V2\HyperpayController@getCheckoutId')->middleware('auth:sanctum');
    Route::get('hyperpay-get-paymentStatus', 'App\Http\Controllers\Api\V2\HyperpayController@getPaymentStatus')->middleware('auth:sanctum');
    ...
    Route::get('products/auth/featured', 'App\Http\Controllers\Api\V2\ProductController@authFeatured')->middleware('auth:sanctum');
    ...
    Route::get('zones', 'App\Http\Controllers\Api\V2\AddressController@getZones');
