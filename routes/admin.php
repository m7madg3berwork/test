...
use App\Http\Controllers\DailyOrderCustomerController;
use App\Http\Controllers\DailyTimeDailvaryController;
use App\Http\Controllers\DigitalProductController;
use App\Http\Controllers\FlashDealController;
use App\Http\Controllers\LanguageController;
use App\Http\Controllers\NewsletterController;
use App\Http\Controllers\NotificationController;
use App\Http\Controllers\OfferDailyController;
use App\Http\Controllers\OfferDailyCustomerController;
...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function () {
    ...
    Route::post('offer_daily_qty_save', [OfferDailyController::class, 'setQtyPost'])->name('offer_daily_qty.save');

    Route::resource('/offer_daily_customer', OfferDailyCustomerController::class);

    Route::resource('/days_time_delivary', DailyTimeDailvaryController::class);


    Route::resource('/daily_order', DailyOrderController::class);
    Route::resource('/daily_order_customer', DailyOrderCustomerController::class);
    ...
    Route::controller(CustomerController::class)->group(function () {
        ...
        Route::get('/customers/change_status/{id}', 'change_customer_status')->name('customers.change-status');
        Route::post('/addWallet', 'AddToWallet')->name('customers.add-wallet');
        Route::post('/addWalletBroadCast', 'AddToWalletBroadCast')->name('customers.add-wallet-broadcast');
    });
