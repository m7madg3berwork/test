...
(function ($) {
    ...
    AIZ.uploader = {
        ...
        updateUploaderFiles: function () {
            ...
            console.log('all files are =>', data)
                ...
                if (data.length > 0) {
                    for (var i = 0; i < data.length; i++) {
                        ...
                        if (data[i].type === "image") {
                            thumb =
                                '<img src="' +
                                AIZ.data.appUrl + '/' +data[i].file_name +
                                '" class="img-fit">';
                        } else {
            ...
            if (AIZ.uploader.data.selectedFiles.length > 0) {
                for (
                    ...
                    if (AIZ.uploader.data.allFiles[index].type === "image") {
                        thumb =
                            '<img src="' +
                            AIZ.data.appUrl + '/' +AIZ.uploader.data.allFiles[index].file_name +
                            '">';
    ...
    AIZ.extra = {
        ...
        deleteConfirm: function () {
            ...
            $(".confirm-add-to-wallet").click(function (e) {
                e.preventDefault();
