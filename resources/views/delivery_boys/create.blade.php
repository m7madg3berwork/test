...
<div class="col-lg-10 mx-auto">
    <div class="card">
        ...
        <form action="{{ route('delivery-boys.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="file" class="form-control" name="national_id_attachment" required>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="file" class="form-control" name="license_id_attachment" required>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="file" class="form-control" name="license_car_attachment" required>
                    </div>
                </div>
