                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <label class="col-md-3 col-from-label">{{ translate('Maximum Purchase Qty') }} <span
                                        class="text-danger">*</span></label>
                                <div class="col-md-8">
                                    <input type="number" lang="en" class="form-control" name="max_qty" value="1"
                                           min="1" required>
                                </div>
                            </div>
                            <div class="form-group row">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input type="number" name="return_policy" id="" placeholder="{{ translate('Returned Policy') }}" class="form-control">
{{--                                    <textarea class="aiz-text-editor" name="return_policy"></textarea>--}}
                                </div>
                            </div>
                        </div>
                    </div>
