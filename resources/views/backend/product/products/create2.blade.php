            ...
            <div class="col-lg-8">
                ...
                <div class="card-body">
                        <div class="form-group row gutters-5">
                            <div class="col-md-3">
                                <input type="text" class="form-control" translatevalue="{{('refundable')}}" disabled>
                            </div>
                            <div class="col-md-8">
                            <input type="number">
...
@ini_set('max_execution_time', 300);
                           @foreach (\App\Models\City::all() as $key => $cities)

                           <option value="{{ $cities->id}}"></option>
                           @endforeach
                       </select>
                            </div>
                        </div>
                        ...
                        {{-- <div class="form-group row">
                            ...
                            <select class="form-control aiz-selectpicker" name="zones_id[]" id="zones_id" data-live-search="true">

                           @foreach (\App\Models\zones::all() as $key => $zones)

                           <option value="{{ $zones->id}}">{{ $zones->getTranslation('name') }}</option>
                           @endforeach
                       </select>
                            </div>
                        </div> --}}
