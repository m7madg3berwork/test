...
<body class="">
        ...
        <div class="aiz-content-wrapper">
            ...
            <div class="aiz-main-content">
                ...
                <div class="bg-white text-center py-3 px-15px px-lg-25px mt-auto">
                    <p class="mb-0">&copy
                        Copyright 2022 © Romooz powered By <a href="http://www.iservetec.com">I Serve Technology.</a>
                        All rights reserved
                    </p>
                </div>
    ...
    <script>
        ...
        function changeActive(userId) {
            ...
            var active = 0;
            if( $("#changeActiveUser"+userId).is(':checked') )
            {
                active = 1;
            }
    
            var url = '{{ route("change_user_active", [
                "userId" => ":userId",
                "active" => ":active"
            ]) }}';
