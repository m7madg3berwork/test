...
<div class="aiz-titlebar text-left mt-2 mb-3">
    <h5 class="mb-0 h6">{{translate('Number  of daily orders for customer  ')}}</h5>
</div>
<form class="form form-horizontal mar-top" action="{{route('daily_order_customer.store')}}" method="POST" enctype="multipart/form-data" id="choice_form">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row gutters-5">
                            ...
                            <div class="col-md-8">
                            <h3 class="aiz-switch aiz-switch-success mb-0">Number for order </h3> 
                            <input type="text" class="form-control" value="{{translate('')}}">
