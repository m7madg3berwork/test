            ...
            <!-- Customers -->
                @if(Auth::user()->user_type == 'admin' || in_array('8', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('customers.index',['customer_type' => 'wholesale']) }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('Wholesales') }}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('customers.index',['customer_type' => 'retail']) }}" class="aiz-side-nav-link">
                ...
                @if(Auth::user()->user_type == 'admin' || in_array('8', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('packages.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['packages.index', 'packages.create', 'packages.edit'])}}">
                            ...
                            @if(Auth::user()->user_type == 'admin' || in_array('2', json_decode(Auth::user()->staff->role->permissions)))
                                <li class="aiz-side-nav-item">
                                    <a class="aiz-side-nav-link" href="{{route('days_time_delivary.create')}}">
                                        <span
                                            class="aiz-side-nav-text">{{translate('Days and Time For Delivary')}}</span>
                                    </a>
                                </li>
                            @endif
{{--                            @if(Auth::user()->user_type == 'admin' || in_array('2', json_decode(Auth::user()->staff->role->permissions)))--}}
...
{{--                                        <span--}}
{{--                                            class="aiz-side-nav-text">{{translate('Delivery`s')}}</span>--}}
{{--                                    </a>--}}
{{--                                </li>--}}
