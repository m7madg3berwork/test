    ...
    <div class="aiz-sidebar left c-scrollbar">
        <div class="aiz-side-nav-logo-wrap">
            <a href="{{ route('admin.dashboard') }}" class="d-block text-left">
                <h2 class="text-center">Romooz</h2>
            </a>
        </div>
        <div class="aiz-side-nav-wrap">
            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                    ...
                    {{-- <ul class="aiz-side-nav-list level-2">--}}
                        ...
                        {{-- <li class="aiz-side-nav-item">--}}
                            {{-- <a href="{{route('auction.inhouse_products')}}" class="aiz-side-nav-link">--}}
                                {{-- <span class="aiz-side-nav-text">{{ translate('Inhouse Auction Products')
                                    }}</span>--}}
                                {{-- </a>--}}
                            {{-- </li>--}}
                        {{-- <li class="aiz-side-nav-item">--}}
                            {{-- <a href="{{route('auction.seller_products')}}" class="aiz-side-nav-link">--}}
                                {{-- <span class="aiz-side-nav-text">{{ translate('Seller Auction Products')
                                    }}</span>--}}
                                {{-- </a>--}}
                            {{-- </li>--}}
                        {{-- <li class="aiz-side-nav-item">--}}
                            {{-- <a href="{{route('auction_products_orders')}}" --}} {{--
                                ...
                                {{-- <span class="aiz-side-nav-text">{{ translate('Auction Products Orders')
                                    }}</span>--}}
                                {{-- </a>--}}
                            {{-- </li>--}}
                        {{-- </ul>--}}
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        {{-- <li class="aiz-side-nav-item">--}}
                            {{-- <a href="{{route('wholesale_products.all')}}" --}} {{--
                                ...
                                {{-- <span class="aiz-side-nav-text">{{ translate('All Wholesale Products')
                                    }}</span>--}}
                                {{-- </a>--}}
                            {{-- </li>--}}{{----}}
                        <li class="aiz-side-nav-item">
                        ...
                        {{-- <li class="aiz-side-nav-item">--}}
                            {{-- <a href="{{route('wholesale_products.seller')}}" --}} {{--
                                class="aiz-side-nav-link {{ areActiveRoutes(['wholesale_product_edit.admin']) }}">--}}
                                {{-- <span class="aiz-side-nav-text">{{ translate('Seller Wholesale Products')
                                    }}</span>--}}
                                {{-- </a>--}}
                            {{-- </li>--}}
                    </ul>
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('customers.index',['customer_type' => 'wholesale']) }}"
                                class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{ translate('Wholesales') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('customers.index',['customer_type' => 'retail']) }}"
                                class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{ translate('Retails') }}</span>
                            </a>
                        </li>
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('packages.index') }}"
                                class="aiz-side-nav-link {{ areActiveRoutes(['packages.index', 'packages.create', 'packages.edit'])}}">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{route('zones.index')}}"
                                class="aiz-side-nav-link {{ areActiveRoutes(['zones.index','zones.edit','zones.update'])}}">
                ...
                {{-- <li class="aiz-side-nav-item">--}}
                    ...
                    {{-- <ul class="aiz-side-nav-list level-2">--}}
                        {{-- <li class="aiz-side-nav-item">--}}
                            {{-- @php--}}
                            {{-- $sellers = \App\Models\Shop::where('verification_status',
                            0)->where('verification_info', '!=', null)->count();--}}
                            {{-- @endphp--}}
                        ...
                        {{-- <li class="aiz-side-nav-item">--}}
                            {{-- <a href="{{ route('seller_verification_form.index') }}" class="aiz-side-nav-link">--}}
                                {{-- <span class="aiz-side-nav-text">{{ translate('Seller Verification Form')
                                    }}</span>--}}
                                {{-- </a>--}}
                            {{-- </li>--}}
                        {{-- </ul>--}}
                ...
                <li class="aiz-side-nav-item">
                    <a href="#" class="aiz-side-nav-link {{ areActiveRoutes(['website.footer', 'website.header'])}}">
                        ...
                        <span class="aiz-side-nav-text">{{translate('Page && Slider')}}</span>
                        <span class="aiz-side-nav-arrow"></span>
                    </a>
                    <ul class="aiz-side-nav-list level-2">
                        <!-- <li class="aiz-side-nav-item">
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        json_decode(Auth::user()->staff->role->permissions)))
                        <li class="aiz-side-nav-item">
                            <a class="aiz-side-nav-link" href="{{route('days_time_delivary.create')}}">
                                <span class="aiz-side-nav-text">{{translate('Days and Time For Delivary')}}</span>
                            </a>
                        </li>
                        @endif
                        {{-- @if(Auth::user()->user_type == 'admin' || in_array('2',
                        json_decode(Auth::user()->staff->role->permissions)))--}}
                        {{-- <li class="aiz-side-nav-item">--}}
                            {{-- <a class="aiz-side-nav-link" href="{{route('daily_order.create')}}">--}}
                                {{-- <span class="aiz-side-nav-text">{{translate('Number of daily orders')}}</span>--}}
                                {{-- </a>--}}
                            {{-- </li>--}}
                        {{-- @endif--}}
                        {{-- <li class="aiz-side-nav-item">--}}
                            {{-- <a class="aiz-side-nav-link" href="{{route('deliveries.index')}}">--}}
                                {{-- <span--}} {{-- class="aiz-side-nav-text">{{translate('Delivery`s')}}</span>--}}
                                    {{-- </a>--}}
                            {{-- </li>--}}
                            ...
                            {{-- <ul class="aiz-side-nav-list level-3">--}}
                                ...
                                {{-- <li class="aiz-side-nav-item">--}}
                                    {{-- <a href="{{ route('facebook-comment') }}" class="aiz-side-nav-link">--}}
                                        {{-- <span class="aiz-side-nav-text">{{translate('Facebook
                                            Comment')}}</span>--}}
                                        {{-- </a>--}}
                                    {{-- </li>--}}
                                {{-- </ul>--}}
