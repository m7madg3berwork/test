        ...
        <tbody>
        	...
        	<tr>
				...
				@if($page->type == 'home_page')
        			<td><a href="javascript:;" class="text-reset">{{ $page->getTranslation('title') }}</a></td>
					<td>{{ $page->type }}</td>
				@else
        			<td><a href="javascript:;"  class="text-reset">{{ $page->getTranslation('title') }}</a></td>
                    <td>{{ $page->type }}</td>
        		...
        		<td class="text-right">
					@if($page->type == 'home_page')
						<a href="{{route('custom-pages.edit', ['id'=>$page->slug, 'lang'=>env('DEFAULT_LANGUAGE'), 'page'=>'home'] )}}" class="btn  btn-sm btn-soft-primary" title="Edit">
							<i class="las la-pen"></i>
                            {{translate('Edit')}}
						</a>
					@else
	          			<a href="{{route('custom-pages.edit', ['id'=>$page->slug, 'lang'=>env('DEFAULT_LANGUAGE')] )}}" class="btn btn-sm btn-soft-primary" title="Edit">
							<i class="las la-pen"></i>
                            {{translate('Edit')}}
						</a>
					@endif
